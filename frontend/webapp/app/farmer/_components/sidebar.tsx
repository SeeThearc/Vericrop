...
import { Home, Package, Search, Clipboard, Settings, HelpCircle, Headphones } from "lucide-react";
...
const routes = [
	...
	{
		label: "Register Produce",
		icon: Package,
		href: "/farmer/register-produce",
	},
	{
	...
	return (
		<div className="fixed left-0 top-0 space-y-4 py-4 flex flex-col h-screen bg-white border-r border-gray-200 text-black w-64 z-50">
			<div className="px-3 py-2 flex-1">
				<Link href="/farmer" className="flex items-center pl-3 mb-14">
