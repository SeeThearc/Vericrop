      ...
      <Table>
        <TableHeader>
          <TableRow className="hover:bg-gray-50">
            ...
            <TableHead className="text-gray-700">Distributer</TableHead>
        ...
        <TableBody>
          {transactions.map((transaction) => (
            <TableRow key={transaction.id} className="hover:bg-gray-50">
              ...
              <TableCell className="text-gray-900">{transaction.distributer}</TableCell>
