    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="vericrop-card-secondary text-center">
          <h3 className="text-sm font-medium text-gray-500 mb-2">Daily Sales</h3>
          <div className="text-3xl font-bold vericrop-text-primary">$1,247</div>
          <p className="text-sm text-green-600">+15% vs yesterday</p>
        </div>
        <div className="vericrop-card-secondary text-center">
          <h3 className="text-sm font-medium text-gray-500 mb-2">Customers Served</h3>
        ...
        <div className="vericrop-card-secondary text-center">
          <h3 className="text-sm font-medium text-gray-500 mb-2">Products Sold</h3>
      ...
      <div className="vericrop-card-primary">
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Store Location & Delivery Areas</h3>
          <p className="text-gray-600">Interactive map showing store location and customer delivery zones</p>
        </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-600">
                    <div className="space-y-2">
                      ...
                      <p><span className="font-medium">Distributor:</span> {transaction.distributor}</p>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                      ...
                      {transaction.feedback && (
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600 italic">&ldquo;{transaction.feedback}&rdquo;</p>
                        </div>
                      )}
                    </div>
                  </div>
