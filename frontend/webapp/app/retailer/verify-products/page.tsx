	...
	return (
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				...
				<div className="vericrop-card-secondary vericrop-hover-scale">
					...
					<div className="text-center mb-4">
						<div className="text-3xl font-bold vericrop-text-primary">96.8%</div>
				...
				<div className="vericrop-card-secondary vericrop-hover-scale">
					...
					<p className="text-sm text-gray-600">
						Advanced AI monitoring for product freshness, quality, and authenticity verification.
					</p>
				</div>
			</div>
			...
			<div className="vericrop-card-primary">
				<div className="mb-6">
					<h3 className="text-xl font-semibold text-gray-900 mb-2">Recent Product Verifications</h3>
					<p className="text-gray-600">Latest product verification activities and customer ratings</p>
				</div>
							...
							<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
								<div className="flex-1">
									...
									<div className="text-sm text-gray-600 space-y-1">
										<p><span className="font-medium">Distributor:</span> {item.distributor}</p>
