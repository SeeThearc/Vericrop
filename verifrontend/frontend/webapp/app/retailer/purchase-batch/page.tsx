    ...
    <div className="space-y-6">
      ...
      <div className="vericrop-card-secondary">
        <div className="flex flex-col md:flex-row gap-4 items-end">
          <div className="flex-1">
            <Label className="text-gray-700 text-sm font-medium mb-2 block">Search Products</Label>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="vericrop-card-secondary text-center">
          ...
          <h4 className="text-sm font-medium text-gray-500 mb-2">Available Products</h4>
          <div className="text-2xl font-bold vericrop-text-primary">312</div>
          <p className="text-sm text-gray-600">In stock</p>
        </div>
        <div className="vericrop-card-secondary text-center">
          <h4 className="text-sm font-medium text-gray-500 mb-2">Trusted Suppliers</h4>
          <div className="text-2xl font-bold vericrop-text-primary">67</div>
          <p className="text-sm text-gray-600">Verified partners</p>
        </div>
        <div className="vericrop-card-secondary text-center">
          <h4 className="text-sm font-medium text-gray-500 mb-2">Avg. Margin</h4>
          <div className="text-2xl font-bold vericrop-text-primary">34.2%</div>
          <p className="text-sm text-gray-600">Profit potential</p>
        </div>
        <div className="vericrop-card-secondary text-center">
          <h4 className="text-sm font-medium text-gray-500 mb-2">Restock Time</h4>
          <div className="text-2xl font-bold vericrop-text-primary">1.8 days</div>
